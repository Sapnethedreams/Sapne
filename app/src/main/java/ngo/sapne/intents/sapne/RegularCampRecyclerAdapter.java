...
public class RegularCampRecyclerAdapter extends RecyclerView.Adapter<RegularCampRecyclerAdapter.RegularCampViewHolder>{

    private List<RegularCampItem> listData = new ArrayList<>();

    public RegularCampRecyclerAdapter(List<RegularCampItem> listData) {
