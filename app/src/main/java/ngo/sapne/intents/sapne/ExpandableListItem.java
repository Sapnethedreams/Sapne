...
public class ExpandableListItem implements OnSizeChangedListener {
    ...
    private String mText,mdesc;
    private boolean mIsExpanded;
    private int mImgResource;
    private int mCollapsedHeight;
    private int mExpandedHeight;

    public ExpandableListItem(String title, int imgResource, String desc,int collapsedHeight, String text) {
        mTitle = title;
...
public  String getdescr(){ return mdesc;}
