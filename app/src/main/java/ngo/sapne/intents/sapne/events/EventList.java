...
public class EventList {
    ...
    public List<EventItem> getData() {
        return Arrays.asList(
                ...
                new EventItem(6, "Lohri Celebration", "Valued event", R.drawable.e7),
                new EventItem(6, "Lohri Celebration", "Valued event", R.drawable.e8),
                new EventItem(6, "Lohri Celebration", "Valued event", R.drawable.e9),
                new EventItem(6, "Lohri Celebration", "Valued event", R.drawable.e10));
    }
