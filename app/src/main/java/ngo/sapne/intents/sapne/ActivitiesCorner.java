...
public class ActivitiesCorner extends Fragment {
    ...
    String[] names = {"One year has passed giving thousands of smiles to people. Thanks to all " +
            ...
            , "On the occasion of it's first anniversary, Sapne is donating blankets and organizing a bhandara for the needy" +
    ...
    Integer images[] = {R.drawable.z1, R.drawable.z2, R.drawable.z3, R.drawable.z4, R.drawable.z5, R.drawable.z6,
